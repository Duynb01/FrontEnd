...
export default function ProductSuper() {
  return (
    <div className="group max-w-[480px] shadow-[0px_0px_3px_rgb(0,0,0,0.1)] rounded-sm">
      <div className="picture p-[5px]">
        <a href="">
          <Image
      ...
      <div className="px-[14px] py-[10px] flex flex-col items-center justify-center">
        ...
        <button className="flex items-center justify-center text-[12px] font-bold rounded-full w-full border border-transparent cursor-pointer transition duration-300 ease-in-out group-hover:border-main">
